...
class EssentialAround : AppCompatActivity(), OnMapReadyCallback {
    ...
    private fun showPinCodeDialog() {
        ...
        btn.setOnClickListener(){
            val et = parentView.findViewById<EditText>(R.id.et_user_pincode)
    ...
    private fun startLocationUpdate(map: GoogleMap){
    ...
    fun openBrowseStoreScreen(view: View){

    }

    fun openAddNeedsScreen(view: View) {
